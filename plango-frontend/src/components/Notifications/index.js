...
const NotificationBar = () => {
  ...
  return (
    ...
    <div class="mx-auto sm:w-3/4 md:w-2/4 fixed inset-x-0 bottom-5" id="signin-success-message">
        <div class={ `${notificationCtx.color} px-6 py-4 my-4 rounded-md text-lg flex items-center justify-around w-full`}>
        ...
        <BsXLg class="justify-self-end" onClick={() => {notificationCtx.clear()}}/>
